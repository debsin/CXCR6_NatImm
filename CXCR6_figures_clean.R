...
c_types = c("LIHC", "BRCA", "STAD", "LAML", "BLCA", "HNSC", "SKCM", "COAD", "READ", "LUAD", "PRAD")
full_names = c("Liver Cancer", "Breast Cancer", "Stomach Cancer","Acute myeloid leukemia",
               "Bladder Cancer", "Head and Neck Cancer", "Skin Cutaneous Melanoma",
               "Colon Cancer", "Rectal Cancer", "Lung Adenocarcinoma", "Prostate Cancer")
names(full_names)  = c_types

gene_symbols = NULL

pdf(file.path("C:/Projects/MISC/signatures.pdf"), width = 8, height = 7)
